...
class DireccionsControllerTest < ActionController::TestCase
  ...
  test "should create direccion" do
    assert_difference('Direccion.count') do
      post :create, direccion: { calle: @direccion.calle, ciudad: @direccion.ciudad, comuna: @direccion.comuna, numero: @direccion.numero, pais: @direccion.pais, region: @direccion.region, trabajador_id: @direccion.trabajador_id }
    end
  ...
  test "should update direccion" do
    patch :update, id: @direccion, direccion: { calle: @direccion.calle, ciudad: @direccion.ciudad, comuna: @direccion.comuna, numero: @direccion.numero, pais: @direccion.pais, region: @direccion.region, trabajador_id: @direccion.trabajador_id }
    assert_redirected_to direccion_path(assigns(:direccion))
  end
