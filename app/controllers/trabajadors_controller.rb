class TrabajadorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @trabajador.save
        format.html { redirect_to @trabajador, notice: 'Registro del Trabajador creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @trabajador.update(trabajador_params)
        format.html { redirect_to @trabajador, notice: 'Datos del trabajador Actualizados!.' }
  ...
  def destroy
    @trabajador.destroy
    respond_to do |format|
      format.html { redirect_to trabajadors_url, notice: 'Datos del Trabajador eliminados !.' }
  ...
  private
    ...
    def trabajador_params
      params.require(:trabajador).permit(:rut, :nombres, :apellidopaterno, :apellidomaterno, :fechanacimineto, :estadocivil, :sexo, :celular, :correo, :cargo)
    end
end
